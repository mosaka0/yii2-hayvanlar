...
/**
 * HayvanlarSearch represents the model behind the search form of `mosaka0\hayvanlar\models\Hayvanlar`.
 */
class HayvanlarSearch extends Hayvanlar
{
    /**
     * {@inheritdoc}
     */
